...
- **Frontend:** plantillas Django + HTMX. Cada endpoint HTMX devuelve un partial en fichero
  suelto (Django 6 no sabe renderizar `plantilla.html#fragmento` desde una vista).
